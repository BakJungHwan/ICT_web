...
$sql = "SELECT title,writer,article FROM notify_board WHERE id=".$_GET['article_id'];
...
<html>
  ...
  <body>
<form action="http://localhost/board/notify_board/modify_process.php" method="post">
